        ...
        >
          ...
          >
            ...
            <Typography
              ...
              paragraph
            >
              By purchasing and passing on Gift 'n Grow repurposed/upcycled gift
              wrap, you can help the environment by...
            </Typography>
            <Typography
              variant='body2'
              paragraph
            >
              <ul className='flex flex-col gap-2'>
                <li>
                  ...
                  be saved by using repurposed/upcycled gift wrap and by passing
                  on the gift wrap.
                </li>
                <li>
          ...
          >
            ...
            >
              ...
              offering our gift wraps. More people are looking for ways to "Go
              Green" and "Gift 'n Grow" does that with our gift wraps. Your
              customers will also enjoy tracking their gift wraps journey online
              as it makes its way around the neighborhood, city, state, or
              country. They are available in a variety of sizes and designs and
